...
-- Copiando estrutura do banco de dados para touchfood
CREATE DATABASE IF NOT EXISTS `touchfood` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `touchfood`;


-- Copiando estrutura para tabela touchfood.ad_adcionais
CREATE TABLE IF NOT EXISTS `ad_adcionais` (
  `ad_id` int(11) NOT NULL auto_increment,
  `ad_descricao` varchar(50) collate utf8_unicode_ci default NULL,
  `ad_valor` int(11) default NULL,
  `ad_tipo` char(50) collate utf8_unicode_ci default NULL,
  PRIMARY KEY  (`ad_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Copiando dados para a tabela touchfood.ad_adcionais: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `ad_adcionais` DISABLE KEYS */;
INSERT INTO `ad_adcionais` (`ad_id`, `ad_descricao`, `ad_valor`, `ad_tipo`) VALUES
	(1, '10%', 0, 'C');
/*!40000 ALTER TABLE `ad_adcionais` ENABLE KEYS */;


-- Copiando estrutura para tabela touchfood.cidade
...
-- Copiando dados para a tabela touchfood.cidade: ~5.675 rows (aproximadamente)
...
-- Copiando estrutura para tabela touchfood.co_comanda
CREATE TABLE IF NOT EXISTS `co_comanda` (
  `co_id` int(11) NOT NULL auto_increment,
  `co_mesa` int(11) default NULL,
  `co_garcom` int(11) default NULL,
  `co_produto` int(11) default NULL,
  `co_adicional` int(11) default NULL,
  PRIMARY KEY  (`co_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Copiando dados para a tabela touchfood.co_comanda: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `co_comanda` DISABLE KEYS */;
/*!40000 ALTER TABLE `co_comanda` ENABLE KEYS */;


-- Copiando estrutura para tabela touchfood.est_estado
CREATE TABLE IF NOT EXISTS `est_estado` (
  `est_id` int(11) NOT NULL,
  `est_abreviatura` varchar(50) collate utf8_unicode_ci default NULL,
  `est_nome` varchar(50) collate utf8_unicode_ci default NULL,
  PRIMARY KEY  (`est_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Copiando dados para a tabela touchfood.est_estado: ~27 rows (aproximadamente)
/*!40000 ALTER TABLE `est_estado` DISABLE KEYS */;
INSERT INTO `est_estado` (`est_id`, `est_abreviatura`, `est_nome`) VALUES
	(1, 'AC', 'Acre'),
	(2, 'AL', 'Alagoas'),
	(3, 'AM', 'Amazonas'),
	(4, 'AP', 'Amapá'),
	...
	(26, 'SP', 'São Paulo'),
	(27, 'TO', 'Tocantins');
/*!40000 ALTER TABLE `est_estado` ENABLE KEYS */;


-- Copiando estrutura para tabela touchfood.func_funcionario
CREATE TABLE IF NOT EXISTS `func_funcionario` (
  `func_id` int(11) NOT NULL auto_increment,
  `func_nome` varchar(50) collate utf8_unicode_ci default NULL,
  `func_cpf` varchar(50) collate utf8_unicode_ci default NULL,
  `func_endereco` varchar(50) collate utf8_unicode_ci default NULL,
  `func_numero` varchar(50) collate utf8_unicode_ci default NULL,
  `func_bairro` varchar(50) collate utf8_unicode_ci default NULL,
  `func_estado` int(11) default NULL,
  `func_cidade` int(11) default NULL,
  PRIMARY KEY  (`func_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Copiando dados para a tabela touchfood.func_funcionario: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `func_funcionario` DISABLE KEYS */;
INSERT INTO `func_funcionario` (`func_id`, `func_nome`, `func_cpf`, `func_endereco`, `func_numero`, `func_bairro`, `func_estado`, `func_cidade`) VALUES
	(1, 'Vitor Higino', '04128325503', 'Rua A', '123', 'Bairro B', 5, 616);
/*!40000 ALTER TABLE `func_funcionario` ENABLE KEYS */;


-- Copiando estrutura para tabela touchfood.log_login
CREATE TABLE IF NOT EXISTS `log_login` (
  `log_id` int(11) NOT NULL auto_increment,
  `log_usuario` varchar(50) collate utf8_unicode_ci default NULL,
  `log_senha` varchar(50) collate utf8_unicode_ci default NULL,
  PRIMARY KEY  (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Copiando dados para a tabela touchfood.log_login: ~1 rows (aproximadamente)
...
-- Copiando estrutura para tabela touchfood.mes_mesa
CREATE TABLE IF NOT EXISTS `mes_mesa` (
  `mes_id` int(11) NOT NULL auto_increment,
  `mes_tamanho` int(11) default NULL,
  `mes_status` char(50) collate utf8_unicode_ci default NULL,
  PRIMARY KEY  (`mes_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Copiando dados para a tabela touchfood.mes_mesa: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `mes_mesa` DISABLE KEYS */;
INSERT INTO `mes_mesa` (`mes_id`, `mes_tamanho`, `mes_status`) VALUES
	(1, 2, 'F'),
	(2, 0, 'O'),
	(3, 0, 'F'),
	(4, 6, 'R'),
...
-- Copiando estrutura para tabela touchfood.prod_produto
CREATE TABLE IF NOT EXISTS `prod_produto` (
  `prod_id` int(11) NOT NULL auto_increment,
  `prod_descricao` varchar(50) collate utf8_unicode_ci default NULL,
  `prod_tipo` char(1) collate utf8_unicode_ci default NULL,
  `prod_valor` int(11) default NULL,
  PRIMARY KEY  (`prod_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Copiando dados para a tabela touchfood.prod_produto: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `prod_produto` DISABLE KEYS */;
INSERT INTO `prod_produto` (`prod_id`, `prod_descricao`, `prod_tipo`, `prod_valor`) VALUES
	(3, 'PorÃ§Ã£o de Batata Frita', 'A', 18),
	(4, '10%', 'C', 0);
